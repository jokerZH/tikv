...
lazy_static! {
    ...
    pub static ref COPR_REQ_ERROR: CounterVec = register_counter_vec!(
        "tikv_coprocessor_request_error",
        "Total number of push down request error.",
        &["reason"]
    ).unwrap();
    pub static ref COPR_PENDING_REQS: GaugeVec = register_gauge_vec!(
    ...
    pub static ref COPR_SCAN_DETAILS: CounterVec = register_counter_vec!(
        "tikv_coprocessor_scan_details",
        "Bucketed counter of coprocessor scan details for each CF",
        &["req", "cf", "tag"]
    ).unwrap();
    pub static ref COPR_EXECUTOR_COUNT: CounterVec = register_counter_vec!(
        "tikv_coprocessor_executor_count",
        "Total number of each executor",
        &["type"]
    ).unwrap();
    pub static ref COPR_GET_OR_SCAN_COUNT: CounterVec = register_counter_vec!(
