...
lazy_static! {
    ...
    pub static ref SNAP_TASK_COUNTER: CounterVec = register_counter_vec!(
    ...
    pub static ref GRPC_MSG_FAIL_COUNTER: CounterVec = register_counter_vec!(
        "tikv_grpc_msg_fail_total",
        "Total number of handle grpc message failure",
        &["type"]
    ).unwrap();
    pub static ref RAFT_MESSAGE_RECV_COUNTER: Counter = register_counter!(
        "tikv_server_raft_message_recv_total",
        "Total number of raft messages received"
    ).unwrap();
    pub static ref RESOLVE_STORE_COUNTER: CounterVec = register_counter_vec!(
        "tikv_server_resolve_store_total",
        "Total number of resolving store",
        &["type"]
    ).unwrap();
    pub static ref REPORT_FAILURE_MSG_COUNTER: CounterVec = register_counter_vec!(
        "tikv_server_report_failure_msg_total",
        "Total number of reporting failure messages",
        &["type", "store_id"]
    ).unwrap();
    pub static ref RAFT_MESSAGE_FLUSH_COUNTER: Counter = register_counter!(
